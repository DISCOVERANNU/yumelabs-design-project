                    ...
                    <div className="3xl:flex lg:flex ">
                        <div>
                            <img
                                src={image1}
                                alt="tablet display"
                                className="md:w-3/4  md:h-full xs:h-96 xs:mb-8 md:mt-0 sm:ml-10 sm:w-5/6 sm:mr-10 xs:w-full md:px-0 lg:ml-0  lg:w-11/12 lg:h-4/6 3xl:ml-0  3xl:h-4/6 3xl:w-full 3xl:mb-20"
                            />
                        ...
                        <div className="3xl:mt-20  ">
                            <img
                                ...
                                className="md:w-3/4 md:h-full md:mt-20 xs:h-96 xs:mb-8  sm:ml-10 sm:w-5/6 sm:h-5/6 sm:mt-16 sm:mr-10 xs:w-full md:px-0 lg:mt-0 lg:w-10/12 lg:h-2/3 lg:ml-24  3xl:h-4/6 3xl:w-11/12 3xl:mb-20 3xl:mt-52"
                            />
                    ...
                    <div className="3xl:flex 3xl:gap-2 lg:flex ">
                        ...
                        <div className=" 3xl:mt-48 ">
                            <img
                                ...
                                className="md:w-3/4 md:h-full md:mt-20 xs:h-96 xs:mb-8 sm:ml-10 sm:w-5/6 sm:mt-20 sm:h-5/6 sm:mr-10 xs:w-full md:px-0  lg:w-5/6 lg:mt-28 lg:h-4/6  3xl:h-3/4 lg:ml-24 3xl:w-11/12 3xl:mt- 3xl:mb-20"
                            />
                            ...
                            <p className="xs:mt-6 xs:text-left xs:h-28 sm:pl-10 xs:font-roboto xs:font-regular xs:text-lg xs:leading-6 xs:text-zinc-850 xs:w-96  lg:mt-8 lg:mb-40  lg:h-32 lg:text-gray-475 lg:leading-6 lg:font-normal lg:ml-20 lg:font-roboto lg:w-96 3xl:w-[640px] 3xl:h-32 3xl:font-roboto 3xl:leading-8 3xl:mb-64 3xl:text-3xl 3xl:font-normal 3xl:text-gray-475 3xl:mt-1">
                                Yumelabs is a global UI UX Design and Industrial Design agency that helps your business
                                scale through fail-proof design innovation systems.
                            </p>
                        </div>
